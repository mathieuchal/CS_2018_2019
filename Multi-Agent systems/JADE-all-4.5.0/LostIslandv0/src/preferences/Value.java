...
public enum Value {
	...
	USELESS, POOR, USEFUL, VERY_USEFUL, NONE, OK, COOL, HOT, AVERAGE, CHEAP, EPENSIVE ;
	...
	public void initialize() {
		...
		possibilities.put(CriterionName.COST, new Value[]{AVERAGE, CHEAP, EPENSIVE});
